...
export default function StudentList() {
  ...
  const athletes =[ 
    ...
    {'id': 10, 'gender': 'M', 'name': 'Eli Phillips', 'events': [2,4,11]},
    {'id': 11, 'gender': 'M', 'name': 'Evan Moyer', 'events': [7,8,9,10]},
    {'id': 12, 'gender': 'M', 'name': 'Gabriel Barraclough', 'events': [2,4,9,11]},
    {'id': 13, 'gender': 'M', 'name': 'Jack Lemieux', 'events': [5,7]},
    {'id': 14, 'gender': 'M', 'name': 'Jackson Sosick', 'events': [7,9]},
    {'id': 15, 'gender': 'M', 'name': 'Jaxon Bailey', 'events': [1,11,12]},
    {'id': 16, 'gender': 'M', 'name': 'Johnathan High', 'events': [2,4,7,10]},
    {'id': 17, 'gender': 'M', 'name': 'Jason Eshelman', 'events': [2,1,10]},
    {'id': 18, 'gender': 'M', 'name': 'Bo Wilson', 'events': [2,7,4,10]},
    {'id': 19, 'gender': 'M', 'name': 'Logan English', 'events': [2,4,9,10]},
    {'id': 20, 'gender': 'M', 'name': 'Lucas Roseman', 'events': [11,12]},
    {'id': 21, 'gender': 'M', 'name': 'Nathan Robison', 'events': [2,6,3]},
    {'id': 22, 'gender': 'M', 'name': 'Nolan Rhine', 'events': [2,4]},
    {'id': 23, 'gender': 'M', 'name': 'Sean Porter', 'events': [5,8,1,10]},
    {'id': 24, 'gender': 'M', 'name': 'Trevor Weltor', 'events': [7]},
    {'id': 25, 'gender': 'M', 'name': 'Tyson Kirchner', 'events': [7,4,9,10]},
    {'id': 26, 'gender': 'M', 'name': 'Tyson Stouffer', 'events': [6,1,9,10]},
  ...
  const getAthletesByEvent = (id) => {
    console.log(athletes.filter((a) => a.events.includes(id)));
